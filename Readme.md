...
# Parsing + Configuration Script – 0003 - Rev. A

This **Parsing + Configuration** script is designed for the **0003** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – 0003 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **0003** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
